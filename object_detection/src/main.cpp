...
#include "object_detection/ocv_common.hpp"
...
int main(int argc, char** argv){
    ...
    cv::Mat curr_frame ;//= Color_pic.clone();
    cv::Mat next_frame;
    ...
    Core ie;
    CNNNetwork cnnNetwork = ie.ReadNetwork("/home/dji/openvino_ws/face-detection-adas-0001/FP16/face-detection-adas-0001.xml");
    ...
    ExecutableNetwork network = ie.LoadNetwork(cnnNetwork, "MYRIAD");
                     ...
                     for (int i = 0; i < maxProposalCount; i++) {
                         ...
                         if (confidence > 0.5) {
                             ...
                             cv::putText(curr_frame,
                                         (std::string("label #") + std::to_string(label)) + conf.str(),
